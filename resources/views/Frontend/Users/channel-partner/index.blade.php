...
<div class="card ">
    <div class="settlement-header">
        <h3 class="settlement-heading">Manage Channel</h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-2">
                <div class="bank-detail-inputs">
                    ...
                    <select class="bank-detail-input form-select select" required name="channel_name" id="channel_name">
                        <option value="">Select Channel Name</option>
                        @foreach($channels as $b)
                        <option>{{$b->first_name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
    ...
    <div class="table-responsive p-4" id="dataTable">
        @include('Frontend.Users.channel-partner.Table.table')
    </div>
</div>
@endsection
@section('script')
