     ...
     <div class="bank-card">
         ...
         <div class="card-form">
             <div class="bank-detail-inputs">
                 ...
                 <input class="bank-detail-input form-control" type="text" name="first_name" id="first_name" placeholder="Enter channel name" value="{{$channelPartner->first_name}}">
             </div>
             <div class="bank-detail-inputs">
                 <label class="bank-input-label">Email<span class="required">*</span></label>
                 <input class="bank-detail-input form-control" type="text" name="email" id="email" placeholder="Enter user email" value="{{$channelPartner->email}}" />
             </div>
             <div class="bank-detail-inputs">
             ...
             <div class="bank-detail-inputs">
                 ...
                 <input class="bank-detail-input form-control" type="number" name="aadhar_number" id="aadhar_number" placeholder="Enter your aadhar number" value="{{$channelPartner->aadhar_number}}" />
             </div>
     ...
     <div class="bank-card">
         ...
         <div class="card-form">
             <div class="bank-detail-inputs">
                 ...
                 <input class="bank-detail-input form-control" type="text" name="address_1" id="address_1" placeholder="Enter Address line 1" value="{{$channelPartner->address_1}}" />
             </div>
             <div class="bank-detail-inputs">
                 <label class="bank-input-label">Address Line 2<span class="required">*</span></label>
                 <input class="bank-detail-input form-control" type="text" name="address_2" id="address_2" placeholder="Enter Address line 2" value="{{$channelPartner->address_2}}" />
             </div>
             <div class=" bank-detail-inputs">
                 <label class="bank-input-label">Landmark<span class="required">*</span></label>
                 <input class="bank-detail-input form-control" type="text" name="landmark" id="landmark" placeholder="Enter landmark" value="{{$channelPartner->landmark}}" />
             </div>
             <div class=" bank-detail-inputs">
                 ...
                 <select class="bank-detail-input form-select" required name="state" id="state">
                     ...
                     <option value="{{$state['state_code']}}" {{($channelPartner->state == $state['state_code'])?'selected':''}}>{{$state['state']}}</option>
                     @endforeach
                 </select>
             </div>
             <div class="bank-detail-inputs">
                 ...
                 <select class="bank-detail-input form-select" required name="district" id="district">
                     ...
                     <option value="{{$district}}" {{($channelPartner->district == $district)?'selected':''}}>{{$district}}</option>
                     @endforeach
                 </select>
             ...
             <div class="bank-detail-inputs">
                 ...
                 <input class="bank-detail-input form-control" type="number" maxlength="6" name="pincode" id="pincode" placeholder="Enter Pincode" value="{{$channelPartner->pincode}}">
             </div>
         </div>
     </div>
     <br>
         ...
         <div class="card-form">
             ...
             <div class="bank-detail-inputs">
                 ...
                 <select class="bank-detail-input form-select" required name="service_type" id="service_type">
                     ...
                     <option value="{{$service->id}}" {{($channelPartner->service_type == $service->id)?'selected':''}}>{{$service->service_name}}</option>
                     @endforeach
                 </select>
             </div>
             <div class="bank-detail-inputs">
                 ...
                 <select class="bank-detail-input form-select" required name="status" id="status">
                     <option value="1" {{($channelPartner->status == 1)?'selected':''}}>Active</option>
                     <option value="0" {{($channelPartner->status == 0)?'selected':''}}>In-Active</option>
                 </select>
             </div>
