 ...
 <div class="bank-card">
     ...
     <div class="card-form">
         <div class="bank-detail-inputs">
             ...
             <input class="bank-detail-input form-control" type="text" name="first_name" id="first_name" placeholder="Enter channel name" value="{{$channelPartner->first_name}}" disabled>
         </div>
         <div class="bank-detail-inputs">
             <label class="bank-input-label">Email<span class="required">*</span></label>
             <input class="bank-detail-input form-control" type="text" name="email" id="email" placeholder="Enter user email" value="{{$channelPartner->email}}" disabled />
         </div>
         <div class="bank-detail-inputs">
             <label class="bank-input-label">Phone Number<span class="required">*</span></label>
             <input class="bank-detail-input form-control" type="tel" maxlength="10" name="phone" id="phone" placeholder="Enter user phone number" value="{{$channelPartner->phone}}" disabled>
         </div>
 ...
 <div class="bank-card">
     ...
     <div class="card-form">
         <div class="bank-detail-inputs">
             ...
             <input class="bank-detail-input form-control" type="text" name="address_1" id="address_1" placeholder="Enter Address line 1" value="{{$channelPartner->address_1}}" disabled />
         </div>
         <div class="bank-detail-inputs">
             <label class="bank-input-label">Address Line 2<span class="required">*</span></label>
             <input class="bank-detail-input form-control" type="text" name="address_2" id="address_2" placeholder="Enter Address line 2" value="{{$channelPartner->address_2}}" disabled />
         </div>
         <div class=" bank-detail-inputs">
             <label class="bank-input-label">Landmark<span class="required">*</span></label>
             <input class="bank-detail-input form-control" type="text" name="landmark" id="landmark" placeholder="Enter landmark" value="{{$channelPartner->landmark}}" disabled />
         </div>
         <div class=" bank-detail-inputs">
         ...
         <div class="bank-detail-inputs">
             ...
             <input class="bank-detail-input form-control" type="tel" maxlength="6" name="pincode" id="pincode" placeholder="Enter Pincode" value="{{$channelPartner->pincode}}" disabled>
         </div>
     </div>
 </div>
 <br>
 <div class=" bank-card">
     ...
     <div class="card-form">
         ...
         <div class="bank-detail-inputs">
             ...
             <input class="bank-detail-input form-control" type="number" min=0 name="account_number" id="account_number" placeholder="Enter Account Number" value="{{$bank->account_number}}" disabled />
         </div>
