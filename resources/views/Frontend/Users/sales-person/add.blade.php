 ...
 <form class="needs-validation" action="{{url('sales-person/create')}}" method="POST" novalidate>
     @csrf
     @if ($errors->any())
     ...
     <div class="bank-card">
         ...
         <div class="card-form">
             <div class="bank-detail-inputs">
                 ...
                 <input class="bank-detail-input form-control" type="text" name="first_name" id="first_name" placeholder="Enter first name">
             </div>
             <div class="bank-detail-inputs">
                 <label class="bank-input-label">Last Name<span class="required">*</span></label>
                 <input class="bank-detail-input form-control" type="text" name="last_name" id="last_name" placeholder="Enter last name">
             </div>
             <div class="bank-detail-inputs">
             ...
             <div class="bank-detail-inputs">
                 ...
                 <input class="bank-detail-input form-control" type="number" maxlength="10" name="phone" id="phone" placeholder="Enter user phone number">
             </div>
             <div class="bank-detail-inputs">
             ...
             <div class="bank-detail-inputs">
                 ...
                 <input class="bank-detail-input form-control" type="tel" name="pan_number" id="pan_number" placeholder="Enter your pan number">
             </div>
             <div class="bank-detail-inputs">
     ...
     <div class="bank-card">
         ...
         <div class="card-form">
             ...
             <div class="bank-detail-inputs">
                 ...
                 <input class="bank-detail-input form-control" type="number" maxlength="6" name="pincode" id="pincode" placeholder="Enter Pincode">
             </div>
         </div>
     </div>
     <br>
