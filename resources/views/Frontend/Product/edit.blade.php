    ...
    <div class="bank-card">
        ...
        <div class="card-form">
            <div class="bank-detail-inputs">
                ...
                <input class="bank-detail-input form-control" type="text" value="{{$product->name}}" name="name" id="name" placeholder="Enter Product Name" required>
            </div>
            <div class="bank-detail-inputs">
                ...
                <select class="bank-detail-input form-select row_select" required name="group" id="group">
                    ...
                    <option value="{{$product->group}}" selected>{{$product->group}}</option>
