    ...
    <div class="bank-card-inside">
        <div class="card-form2">
            <div class="toggle-contaenr">
                ...
                <div class="bank-detail-inputs " id="add-more-section_{{ $product->id }}" style="display: none;">
                    <br> <button class="add-p-btn add-more" data-product="{{ $product->id }}">Add More</button>
                </div>
            </div>
        </div>
        <div class="input-grid" id="product_{{ $product->id }}_details" style="display: none;">
            <div class="bank-detail-inputs percentage-section" style="display: none;">
                <label class="bank-input-label">Percentage</label>
                <input class="bank-detail-input percentage" id="percentage_{{ $product->id }}_1" type="number" placeholder="Enter percentage" />
            </div>
            <div class="bank-detail-inputs min-value-section">
                <label class="bank-input-label">Minimum Value</label>
                <input class="bank-detail-input min-value" type="number" id="min_value_{{ $product->id }}_1" placeholder="Enter minimum value" />
            </div>
            <div class="bank-detail-inputs max-value-section">
                <label class="bank-input-label">Maximum Value</label>
                <input class="bank-detail-input max-value" type="number" id="max_value_{{ $product->id }}_1" placeholder="Enter maximum value" />
            </div>
            <br>
            <br>
        </div>
...
<div class="save-btn-container">
    <button type="submit" class="save-btn">Submit Deatils</button>
</div>
@endif
