...
<form class="needs-validation" action="{{ url('bank-payout/create') }}" method="POST">
    @csrf
    @if ($errors->any())
    ...
    <div class="bank-card">
        ...
        <div class="card-form">
            ...
            <div class="bank-detail-inputs">
                ...
                <input class="bank-detail-input form-control" type="number" min=0 name="payout_rate" id="payout_rate" placeholder="Enter payout rate">
            </div>
