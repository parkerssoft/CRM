 ...
 <h2>Add Staff </h2>
 <form class="needs-validation" action="{{url('staff/create')}}" method="POST" novalidate>
     @csrf
     @if ($errors->any())
     ...
     <div class="bank-card">
         ...
         <div class="card-form">
             ...
             <div class="bank-detail-inputs">
                 ...
                 <input class="bank-detail-input form-control" type="tel" maxlength="10" name="phone" id="phone" placeholder="Enter user phone number">
             </div>
             <div class="bank-detail-inputs">
