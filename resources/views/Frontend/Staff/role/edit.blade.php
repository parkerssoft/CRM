...
@section('body')
<h2>Edit Role</h2>
<form action="{{url('/staff/update/role/'.$role->id)}}" method="POST">
        @method('PUT')
        @csrf
        @if ($errors->any())
        ...
        <div class="bank-card">
                ...
                <div class="card-form">
                        <div class="bank-detail-inputs">
                                ...
                                <select class="bank-detail-input form-select row_select" required name="name" id="name">
                        ...
                        <div class="bank-detail-inputs">
                                <label class="bank-input-label">Status<span class="required">*</span></label>
                                <!-- <input class="bank-detail-input form-control" type="text" name="disbAmount" id="disbAmount" placeholder="Enter Disburse Amount" required> -->
