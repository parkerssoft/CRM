...
<div class="card">
    <div class="application-header">
        <h3 class="application-heading">All Bank Target</h3>
    ...
    <div class="table-responsive p-4" id="dataTable">
        @include('Frontend.BankTarget.Table.target_table')
...
@section('modal')
<div class="modal" id="createBankTarget">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header" style="padding: 2px 15px;">
                <h5 class="modal-title">Add Bank Target</h5>
            ...
            <div class="modal-body" style="padding: 20px 25px;">
                <form action="{{url('bank-target/create')}}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-12 p-2">
                            <label class="input-label">Target Amount<span class="required">*</span></label>
                            <input type="text" class="form-control" placeholder="Enter target amount" name="target_amount" id="target_amount" required>
                        </div>
                    </div>
...
<div class="modal" id="editTargetModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header" style="padding: 2px 15px;">
                <h5 class="modal-title">Edit Bank Target</h5>
                <button type="button" class="btn custom-close-btn" data-bs-dismiss="modal">
                    <img src="{{asset('assets/images/cancel-icon.svg')}}" alt="Cancel">
                </button>
            </div>
            ...
            <div class="modal-body" style="padding: 20px 20px;">
                <form id="editTargetForm">
                    ...
                    <div class="row">
                        <div class="col-12 p-2">
                            <label class="input-label">Target Amount<span class="required">*</span></label>
                            <input type="text" class="form-control" placeholder="Enter target amount" name="target_amount" id="edit_target_amount" required>
                        </div>
                    </div>
                    <div class="save-btn-container">
                        <button type="submit" class="save-btn">Save</button>
...
@section('script')
@include('Frontend.BankTarget.index_js')
@endsection