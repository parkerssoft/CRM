...
<div class="card">
    <div class="application-header">
        <h3 class="application-heading">All Bank Product</h3>
        <div class="btn-container">
            <button class="application-header-btn" data-bs-toggle="modal" data-bs-target="#createBankProduct">
    ...
    <div class="table-responsive p-4" id="dataTable">
        @include('Frontend.BankProduct.Table.bank_table')
    </div>
</div>
<!-- /# row -->
@endsection
...
@section('modal')
<div class="modal" id="createBankProduct">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 20px 25px;">
                <form action="{{url('bank/create/product/create')}}" method="POST">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 p-2">
                            <label class="input-label">Auto Generate LAN<span class="required">*</span></label>
                            <select class="form-select" required name="auto_generate_lan" id="auto_generate_lan">
...
<div class="modal" id="editBankProductModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 20px 20px;">
                <form id="editBankProductForm">
                    ...
                    <div class="row">
                        <div class="col-12 p-2">
                            <label class="input-label">Select Bank<span class="required">*</span></label>
                            <select class="form-select" required name="bank_id" id="editBankId">
                                <option value="" selected disabled>Select Bank</option>
                                @foreach($banks as $bank)
                                <option value="{{$bank->id}}">{{$bank->name}}</option>
                                @endforeach
                    ...
                    <div class="row">
                        <div class="col-12 p-2">
                            <label class="input-label">Product name<span class="required">*</span></label>
                            <select class="form-select" required name="product_id" id="editProductName">
                                <option value="" selected disabled>Select Product</option>
                                @foreach($products as $product)
                                <option value="{{$product->id}}">{{$product->name}}</option>
                                @endforeach
...
@section('script')
@include('Frontend.BankProduct.index_js')
@endsection